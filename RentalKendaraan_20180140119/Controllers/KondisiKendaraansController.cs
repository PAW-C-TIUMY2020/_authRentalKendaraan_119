...
namespace RentalKendaraan_20180140119.Controllers
{
    public class KondisiKendaraansController : Controller
    {
        ...
        {
            var rental_KendaraanContext = _context.KondisiKendaraan.Include(k => k.IdKondisiNavigation);
        ...
        {
            ViewData["IdKondisi"] = new SelectList(_context.Pengembalian, "IdPengembalian", "IdPengembalian");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKondisi,NamaKondisi")] KondisiKendaraan kondisiKendaraan)
        {
            ...
            ViewData["IdKondisi"] = new SelectList(_context.Pengembalian, "IdPengembalian", "IdPengembalian", kondisiKendaraan.IdKondisi);
            return View(kondisiKendaraan);
        }
